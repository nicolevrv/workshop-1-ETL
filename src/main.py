...
if __name__ == "__main__":
    ...
    # build all six dimension tables, and construct the fact table.
    # The function returns a tuple of seven DataFrames which are unpacked here
    ...
    # ----------------------------------------------------------------
    # Insert all seven DataFrames into their corresponding *_stg tables
